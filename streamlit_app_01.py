    ...
    if sigs:
        ...
        for sig in sigs[:3]:
            ...
            sig_items += f"""<div class="social-item">
              ...
              {link}
              <div style="margin-top:4px;">{sig.get('text','')[:180]}</div>
            </div>"""
    ...
    <div class="topic-card {star_cls}">
      <div class="card-inner">
        ...
        <div class="card-body">
          ...
          <div class="summary">{story.get('summary','')}</div>
          <div class="signal-box" style="border-left:3px solid {sc};">
            <span class="signal-label" style="color:{sc};">SIGNAL · </span>{story.get('signal','')}
          </div>
          {social_html}
        </div>
